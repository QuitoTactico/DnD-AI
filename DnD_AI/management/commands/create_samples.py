...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        Character.objects.get_or_create(is_playable=True, name='Frieren the Slayer', 
                                        ...
                                        physical_description='Female white-haired elf with twintails', level=50,
                                        intelligence=100)[0].save()
        
        Monster.objects.get_or_create(  name='Aura the Gilloutine', 
                                        image='entity/images/Aura.png',
                                        icon='entity/icons/Aura_icon.png',
                                        character_race='Demon', character_class='Mage',
                                        story='Old hag. Terrible demon.',
                                        physical_description='Female purple-haired demon with horns and buns', level=50,
                                        intelligence=1)[0].save()
