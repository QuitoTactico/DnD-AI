...
class Command(BaseCommand):
    help = (
        "Creates some examples of playable and non-playable characters in the database"
    )
    ...
    def handle(self, *args, **kwargs):
        ...
        self.stdout.write(
            self.style.SUCCESS(
                "Successfully created some examples of playable and non-playable characters, monsters and weapons in the database"
            )
        )
