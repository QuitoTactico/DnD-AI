...
DEFAULT_RACE_PER_TILE_TYPE = {
    ...
    "god": ["Angel", "Fairy", "Unicorn", "Elf", "Alien"],
    "psycho": ["Vampire", "Werewolf", "Demon", "Ghost", "Chimera", "Hydra", "Medusa"],
    "hell": ["Demon", "Dragon", "Skeleton", "Zombie", "Vampire", "Golem", "Ghost"],
    "path": ["Human", "Elf", "Centaur", "Harpy", "Goblin", "Demon", "Ghost", "Medusa"],
    "dungeon": [
        "Mummy",
        "Skeleton",
        "Minotaur",
    ...
    "portal": ["Alien", "Chimera", "Dragon", "Fairy", "Ghost"],
}
...
COOL_BOSSES_WITH_ICON = [
    ...
    "The Default Image",
    "The Game",
    "The People Who Plays This Shit",
    ...
    "Vitruvian Man",
    "War Criminal",
    "What Have You Done To My Precious Game",
    "When Te Ries",
    "When",
    "Witch Queen",
    "Wtf",
    "Wyvern",
    "You Dont Want To Know Whats This",
    "You Guys Seeing My Memes",
    "You Reacting At My Bad Jokes",
    "Your Dad",
    "06 08 1945",
    "A Man",
    "Api Key Bully",
    "Are You On A Chair",
    "Arthur King (But Better)",
    "Astolfo",
    "Baldurs Gate Bear",
    "Bwis",
    "Camaron Mantis",
    ...
    "What",
    "Xd",
    "You Thought This Was A Boss But Its Me Dio",
]
